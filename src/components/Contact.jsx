    ...
    return (
        <section
         id="contact"
            className="section"
         >
            <div className="containerlg:grid lg:grid lg:grid-cols-2
                lg:items-stretch
            ">
                ...
                <form 
                    action="https://getform.io/f/arooxgdb"
                    method="POST"
                ...
                >
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2 ">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="text-field"
                                autoComplete="email"
                                placeholder="Diopoumar03@gmail.com"
                    ...
                    <div className="mb-4 ">
                        ...
                        <textarea
                            ...
                            required
                            placeholder="Hi Oumar, I would like to discuss a project with you."
